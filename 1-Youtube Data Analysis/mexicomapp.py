# -*- coding: utf-8 -*-
"""
Created on Mon Oct 28 21:15:07 2019
...
df = pd.read_csv('MXvideos.csv',encoding='latin1')
df.head()
df_categories = pd.read_json('MX_category_id.json')
...
df_summary
df_summary.drop(['video_error_or_removed'], inplace=True)
